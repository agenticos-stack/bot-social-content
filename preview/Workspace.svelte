...
<header class="topbar">
  <div class="identity"><BrandMark /><span class="brand-name">Agentic<span class="brand-os">OS</span></span><span class="slash">/</span><strong>Social Content</strong><span class="edition">DEV PREVIEW</span></div>
  <div class="dev-controls">
    <label for="canvas-language">Canvas language</label>
    <select id="canvas-language" bind:value={nextLocale} aria-describedby="language-hint">
...
<main style={`--bot-chat-width:${chatWidth}px`}>
  ...
  {#snippet canvas()}
    ...
    <p class="scenario-note" id="language-hint">Sample data · changing scenario or language resets canvas edits. Dev controls stay in English.</p>
...
.brand-name{font-family:var(--font-brand);font-weight:620;letter-spacing:-.02em}.brand-os{color:var(--color-act-hover)}
  ...
  .chat-heading p,.assistant-intro small,.canvas-tools button{color:var(--color-ink-soft)}
  @media(max-width:760px){

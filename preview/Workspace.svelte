...
<header class="topbar">
  <div class="identity"><span class="brand" aria-hidden="true">a<span>·</span></span><span class="brand-name">AgenticOS</span><span class="slash">/</span><strong>Social Content</strong><span class="edition">DEV PREVIEW</span></div>
  <span class="mode"><span aria-hidden="true">●</span> Local fixture</span>
</header>
<div class="notice">Development shell · synthetic content · no live AI or publishing.</div>
...
<style>
  ...
  .topbar{height:68px;display:flex;align-items:center;justify-content:space-between;padding:0 28px;border-bottom:1px solid var(--color-panel-subtle);background:var(--color-panel)}.identity{display:flex;align-items:center;gap:16px}.brand{font-family:var(--font-brand);font-size:38px;font-weight:700;line-height:1}.brand span{color:var(--color-act-hover)}.brand-name{font-weight:700;letter-spacing:-.3px}.slash{color:var(--color-ink-faint)}.identity strong{font-weight:500}.edition{font-size:9px;letter-spacing:1.6px;color:var(--color-ink-faint);border:1px solid var(--color-panel-subtle);border-radius:4px;padding:5px 7px}.mode{font-size:11px;color:var(--color-ink-soft);background:var(--color-paper);padding:7px 10px;border-radius:20px}.mode span{font-size:8px;margin-right:5px}.notice{text-align:center;height:30px;display:flex;align-items:center;justify-content:center;font-size:10px;color:var(--color-ink-soft);background:var(--color-paper);border-bottom:1px solid var(--color-panel-subtle);letter-spacing:.2px}main{height:calc(100dvh - 98px);min-height:420px}.eyebrow{font-size:9px;letter-spacing:1.8px;font-weight:650;color:var(--color-ink-faint)}.chat-heading{padding:28px 28px 20px;border-bottom:1px solid var(--color-panel-subtle)}.chat-heading>div{display:flex;justify-content:space-between;align-items:center}h1{font-family:var(--font-sans);font-weight:400;font-size:32px;line-height:1.14;letter-spacing:-1px;margin:14px 0}h1 em{font-weight:400;color:var(--color-act-hover)}.spark{color:var(--color-act-hover);font-size:42px;font-weight:200}.chat-heading p{font-size:12px;line-height:1.7;color:var(--color-ink-faint);margin:0;max-width:28ch}.transcript{flex:1;overflow:auto;padding:25px 24px;min-height:0}.assistant-intro{display:flex;gap:12px}.avatar{background:var(--color-panel-subtle);border:1px solid var(--color-line-strong);min-width:29px;height:29px;border-radius:9px;display:grid;place-items:center;font:700 19px var(--font-brand)}.assistant-intro strong{font-size:11px}.assistant-intro small{display:block;font-weight:400;color:var(--color-ink-faint);font-size:9px;margin-top:4px}.assistant-intro p,.message p{font-size:12px;line-height:1.8;margin:12px 0;white-space:pre-wrap}.muted{color:var(--color-ink-faint)}.suggestions{margin:28px 0 0 41px}.suggestions .eyebrow{font-size:8px}.suggestions button{display:flex;justify-content:space-between;gap:12px;width:100%;text-align:left;background:transparent;border:0;border-bottom:1px solid var(--color-panel-subtle);padding:13px 0;font-size:11px;line-height:1.5;color:var(--color-ink-soft)}.suggestions button:hover{color:var(--color-act-hover)}.suggestions button span{color:var(--color-act-hover)}.message{padding:8px 0}.message small{font-size:10px;color:var(--color-ink-faint)}.user-message{border-radius:12px;background:var(--color-panel-subtle);margin:14px 0;padding:12px 14px}.user-message p{margin:5px 0}.composer-wrap{padding:12px 20px 16px}.composer-wrap form{border:1px solid var(--color-line-strong);border-radius:14px;background:var(--color-panel);padding:12px;box-shadow:0 4px 18px transparent}textarea{resize:none;border:0;width:100%;background:transparent;font-size:12px;line-height:1.6;color:var(--color-ink);padding:3px;min-height:58px}textarea:focus{outline:0}.composer-wrap form:focus-within{outline:2px solid var(--color-act-hover);outline-offset:2px}.composer-footer{display:flex;align-items:center;justify-content:space-between;color:var(--color-ink-faint);font-size:9px}.send{width:30px;height:30px;border-radius:9px;background:var(--color-ink);color:var(--color-panel);border:0;font-size:20px}.send:disabled{background:var(--color-panel-subtle);color:var(--color-ink-faint)}.privacy{font-size:9px;text-align:center;color:var(--color-ink-faint);margin:10px 0 0}.context{display:flex;gap:6px;align-items:center;font-size:10px;margin:0 0 9px;color:var(--color-ink-soft)}.context-dot{width:6px;height:6px;background:var(--color-ink-faint);border-radius:50%}.context-name{overflow:hidden;white-space:nowrap;text-overflow:ellipsis;max-width:110px;color:var(--color-ink-faint)}.canvas-tools{display:flex;justify-content:space-between;align-items:center;padding:0 32px;border-bottom:1px solid var(--color-panel-subtle);gap:12px}.canvas-tools nav{display:flex;gap:22px}.canvas-tools button{background:none;border:0;border-bottom:2px solid transparent;color:var(--color-ink-faint);font-size:11px;padding:12px 0}.canvas-tools button[aria-pressed=true]{color:var(--color-ink);border-color:var(--color-act-hover);font-weight:600}.resize{display:flex;gap:8px;font-size:9px;align-items:center;color:var(--color-ink-faint)}.resize input{width:60px;accent-color:var(--color-act-hover)}.scenario-note{font-size:9px;color:var(--color-ink-faint);padding:9px 32px;margin:0;background:var(--color-panel)}iframe{width:100%;border:0;min-height:0;display:block;background:var(--color-panel)}.canvas-footer{display:flex;justify-content:space-between;padding:10px 28px;font-size:9px;color:var(--color-ink-faint);border-top:1px solid var(--color-panel-subtle);background:var(--color-panel)}.mobile-switch{display:none}.sr-only{position:absolute;width:1px;height:1px;overflow:hidden;clip-path:inset(50%)}
  @media(max-width:1050px){.resize{display:none}.canvas-tools{padding:0 20px}.chat-heading{padding:24px 22px}h1{font-size:29px}.transcript{padding:20px}}
  @media(max-width:760px){.topbar{height:58px;padding:0 16px}.identity{gap:10px}.brand-name,.edition,.slash{display:none}.identity strong{font-size:13px}.notice{font-size:9px;padding:0 12px;height:36px}.mobile-switch{display:flex;padding:6px 16px;gap:8px;background:var(--color-panel);border-bottom:1px solid var(--color-panel-subtle)}.mobile-switch button{flex:1;border:0;border-radius:7px;padding:9px;color:var(--color-ink-faint);background:var(--color-paper)}.mobile-switch button[aria-pressed=true]{background:var(--color-ink);color:var(--color-panel)}main{height:calc(100dvh - 145px)}.canvas-tools nav{gap:18px}.scenario-note{padding:9px 20px}.canvas-footer{padding:10px 16px;font-size:8px}.chat-heading h1 br{display:none}.chat-heading h1{font-size:26px}.chat-heading p{max-width:none}.chat-heading{padding:20px}.chat-heading .spark{font-size:30px}.chat-heading h1 em{margin-left:5px}.suggestions{margin-top:18px}}

  /* Compact development chrome; installed bots render only the canvas document. */
  .topbar{height:48px;padding:0 20px}
  .brand{font-size:28px}
  .notice{height:28px;font-size:12px}
  main{height:calc(100dvh - 76px)}
  .chat-heading{padding:20px}
  .chat-heading h1{font-size:24px;margin:10px 0}
  .chat-heading .spark{display:none}
  ...
  .assistant-intro small,.privacy,.composer-footer,.eyebrow,.scenario-note{font-size:11px}
  .muted,.privacy,.scenario-note{color:var(--color-ink-soft)}
  ...
  @media(max-width:760px){
    .notice{height:36px;font-size:11px}
